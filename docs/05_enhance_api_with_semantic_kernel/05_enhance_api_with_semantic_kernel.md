...
Semantic Kernel is an open-source SDK that lets you easily build agents that can call your existing code. You have already assisted Arauco Rooms Demo with incorporating Semantic Kernel into their existing API infrastructure.

In this exercise, you will expand on the work you did with Semantic Kernel in Exercise 02 and dive into the LLM orchestration capabilities it provides. By combining Arauco Rooms Demo' existing C# and Python code with Semantic Kernel, you will build agents that answer questions and automate processes. You will also use prompt filtering and explore some prompt engineering techniques.
