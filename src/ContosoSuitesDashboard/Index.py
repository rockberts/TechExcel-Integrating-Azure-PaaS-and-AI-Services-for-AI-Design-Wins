...
def main():
    ...
    st.write(
    """
    # Arauco Rooms Demo Main Page

    This Streamlit dashboard is intended to serve as a proof of concept of Azure OpenAI functionality for Arauco Rooms Demo employees.  It is not intended to be a production-ready application.
